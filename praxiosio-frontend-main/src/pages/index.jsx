...
//     //here  is code of onclick
//    const [bannerText, setBannerText] = useState('WELCOME TO PRAXISIO');
...
//    useEffect(() => {
//     var headingTyped = new Typed(headingRef.current, {
//         strings: rotations,
//         typeSpeed: 150,
//         backSpeed: 150,
//         loop: true,
...
//             setBannerText(texts[arrayPos]);
//         },
//     });

//     var paragraphTyped = new Typed(paragraphRef.current, {
//         strings: texts,
//         typeSpeed: 30,
//         backSpeed: 30,
//         loop: true,
...
//     // Use the cardName parameter to determine which card was clicked
//     // Update the displayText state variable based on the clicked card
...
//     <li>2. Translate different programming languages
...
//     <li>3. Formula explanation which is used in the solution
//         and creation of formula detail.</li>
//     <li>4. More than 1 method to solve one question.</li>
//     <li>5. Answer using graphs (if possible) with dummy
...
//             <div>
//                 <ul>
//             <li>1. The user can get detail related to following <br></br>
//                 things such as:
//             <li>a. Human</li>
//             <li>b. Animals</li>
//             <li>c. Plants</li>
...
//     <li>3. Parts and parts of parts of these things <br></br>
//         and their position in the body/thing.</li>
...
//     <li>9. Can know about the combination of medicine <br></br>
//          to be used and also some similar medicines.</li>
...
//     <li>17. Can see images of species (Get from  <br></br>
//         API if possible or cancel it)</li>
//     <li>18. Can ask the questions</li>
//     <li>19. Can translate the details and listen in <br></br>
//          any language</li>
//     <li>read more</li>
//                 </ul>
//             </div>
...
//                                <h3 className="txt-rotate heading cursor"></h3>
//                               <p className="cursor paragraph cursor">I am Ali Shan mern stact developer</p>
//                             </div>

//                             {/* <div  className="banner-left-text "  role="presentation" >
//                               <h2 className="txt-rotate ">{rotations[rotationIndex]}</h2>
//                               <p className="cursor">{displayText}</p>
//                             </div>    */}

//                         </div>

//                         {showRightBox &&  (<div className="col-md-5 p-0" data-aos="fade-down-left"  data-aos-duration="2000" id="right" >
    ...
    if (cardName === "Chemicals") {
      ...
      setBannerText(
        <div>
          ...
          <li>9. Save the reaction and their details.</li>
          <li>
            10. Translate results into any language <br />
            and listen.
          </li>
          <li>11. Remove plagiarism before copying.</li>
          <li>
            12. Know recommendations for quantity <br /> adjustments.
          </li>
          <li>13. Know about cautions of reactions.</li>
          <li>And more.</li>
        </div>
      ...
      setBannerText(
        <div>
          <ul>
            <li>1. Compile more than 25 programming languages.</li>
            <li>
              2. Translate different programming languages <br></br>
              to others and get details of translated code.
            </li>
            <li>3. Concise the code into less line.</li>
            <li>4. Get details of errors and fix them.</li>
            <li>5. Get the syntax and rules of different language.</li>
      ...
      // var delayInMilliseconds = 10000; // 5 seconds (adjust as needed)
      ...
      setBannerText(
        <div>
          <ul>
            ...
            <li>2. All types of Physics/Chemistry numerical solutions.</li>
            <li>
              3. Formula explanation which is used in the <br></br>
              solution and creation of formula detail.
            </li>
            <li>4. More than 1 method to solve one question.</li>
            <li>
              5. Answer using graphs (if possible) with dummy<br></br>
              values more and less than given values.
            </li>
            <li>6. Recommendations to increase and decrease the values.</li>
            <li>7. Save the result like other sections.</li>
            <li>8. Ask anything, can translate the answer and can listen.</li>
            <li>
              9. Can learn in a step-by-step way like in the compiler section.
            </li>
            <li>10. Detail of all formulas will be given in detail button.</li>
            <li>read more</li>
          </ul>
      ...
      setImage(
        <div>
          <img src={keysImg} className="img-fluid calculator" alt="" />
          <h6>Calculations</h6>
        </div>
      );
      // var delayInMilliseconds = 10000; // 5 seconds (adjust as needed)
      ...
      setBannerText(
        <div>
          <ul>
            <li>
              1. The user can get detail related to following <br></br>things
              such as:
              <ul>
                <li>a. Human</li>
                <li>b. Animals</li>
            ...
            <li>2. User can get how to stay/keep healthy.</li>
            <li>
              3. Parts and parts of parts of these <br></br>
              things and their position in the body/thing.
            </li>
            <li>4. Can get the detail of physical changes.</li>
            <li>5. Can know about symptoms.</li>
            <li>6. Can know about Diseases.</li>
            ...
            <li>8. About exercises for physical changes.</li>
            <li>
              9. Can know about the combination of <br></br>
              medicine to be used and also some similar medicines.
            </li>
            <li>10. Causes of this disease</li>
            <li>11. Side effects of the medicines.</li>
            <li>12. Elements of which the medicine is created</li>
            ...
            <li>16. User can save like in other sections.</li>
            <li>
              17. Can see images of species (Get from API if <br></br> possible
              or cancel it)
            </li>
            <li>18. Can ask the questions</li>
            <li>
              19. Can translate the details and listen <br></br> in any language
            </li>
            <li>read more</li>
          </ul>
        </div>
          ...
          <div className="row">
            ...
            <div className="col-md-4 d-flex justify-content-end">
              <div className="login-button">
                ...
                />
                <label
                  className="btn bg-white text-black rounded-pill"
                  htmlFor="option6"
                >
                  SIGNUP
                </label>
          ...
          <div className="row align-items-center">
            ...
            {showRightBox && (
              ...
              >
                ...
                <div className="button-box text-end " >
                  <a href="/Categories" className="btn rounded-pill btn-primary">
                    DIVE IN
                  </a>
                </div>
              </div>
          ...
          <div className="row">
            ...
            >
              <div
                ...
                onClick={() => handleChemicalsClick("Chemicals")}
              >
                <div className="services-icon">
                  <img src={flaskImg} className="img-fluid" alt="" />
                </div>
            ...
            >
              <div
                ...
                onClick={() => handleChemicalsClick("Codes")}
              >
                <div className="services-icon">
                  <img src={programingImg} className="img-fluid" alt="" />
                </div>
            ...
            >
              <div
                className="services-box"
                onClick={() => handleChemicalsClick("Calculations")}
              >
                <div className="services-icon">
                  <img src={keysImg} className="img-fluid" alt="" />
                </div>
            ...
            >
              <div
                className="services-box"
                onClick={() => handleChemicalsClick("Medicines")}
              >
                <div className="services-icon">
                  <img src={pharmacyImg} className="img-fluid" alt="" />
                </div>
      ...
      <div className="overlay-content">
        <div className=" text-center text-white">
          <p className="text-white">
            A project of SKP Developers by{" "}
            <a
              href=""
            ...
            >
              {" "}
              Muhammad Muqeem Malik
            </a>
          </p>
          <img src={logo1} alt="hallo" width="20px" className="image" />
          &nbsp;
          <span>
            <a
              href=""
